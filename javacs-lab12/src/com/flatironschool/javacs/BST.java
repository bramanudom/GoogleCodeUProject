...
******************************************************/
   ...
   private Node<T> delete(Node<T> p, T toDelete)
   {
      ...
      else
      {
         ...
         {
         // get count from the rightmost node in the left subtree
            p.count = retrievecount(p.left);
         // delete the rightmost node in the left subtree
            p.left =  delete(p.left, p.count) ;
         }
      }
      return p;
   }
   private T retrievecount(Node<T> p)
   {
 ...
 **************************************************/
   ...
   public String toString()
   {
      ...
      for(T count : this) sb.append(count.toString());
 ...
 **************************************************/
   ...
   private Node<T> cloneHelper(Node<T> p)
   {
      if(p == null)
         ...
         return new Node<T>(p.count, cloneHelper(p.left), cloneHelper(p.right));
   }
   ...
   private class MyIterator implements Iterator<T>
   {
      ...
      public T next()
      {
         ...
         else
         {
            ...
            {
               if(stk.isEmpty()) return cur.count;
               tmp = stk.pop();
            }
            stk.push(tmp.right);
         }
...
******************************************************/
   ...
   private class Node<T>
   {
      ...
      public Node(String url, T count, Node<T> l, Node<T> r)
      {
         left = l; right = r;
         this.url = url;
         this.count = count;
      ...
      public Node(T count, Node<T> l, Node<T> r)
      {
         left = l; right = r;
        // this.url = url;
         this.count = count;
      ...
      public Node(String url, T count)
      {
